...
class Plugin {
	...
	public static function admin_head() { ?>
		...
		if ( $is_user_white_label ) { ?>
            <style>
                [data-slug="wps-bidouille"].active .column-description:after, [data-slug="plugin-security-scanner"].active .column-description:after, [data-slug="wps-hide-login"].active .column-description:after, [data-slug="block-bad-queries"].active .column-description:after {
                    content: "";
                }

                [data-slug="wps-bidouille"].active .column-primary, [data-slug="block-bad-queries"].active .column-primary, [data-slug="plugin-security-scanner"].active .column-primary, [data-slug="wps-hide-login"].active .column-primary {
